...
class CtlToMatIo extends Bundle() 
{
   val stall     = Output(Bool())
   val pc_sel    = Output(UInt(PC_4.getWidth.W)) 
   val op1_sel   = Output(UInt(OP1_X.getWidth.W)) 
   ...
   val csignals =
      ListLookup(io.dat.inst,                                                                                       
               ...
               Array(       /* val  |  BR  |  op1   |   op2     |  ALU    |  wb  | rf   | mem  | mem  | mask |  csr  */
                  ...
                  //cyp_modify_begin
                  TPUP    -> List(Y, BR_N  , OP1_RS1, OP2_RS2 , TPU_PRE ,  WB_X  , REN_1, MEN_1, M_XRD, MT_W,  CSR.N),
                  TPUA    -> List(Y, BR_N  , OP1_RS1, OP2_RS2 , TPU_ACT ,  WB_X  , REN_1, MEN_1, M_XWR, MT_W,  CSR.N),
                  //cyp_modify_end
                  ...
                  //cyp_modify_begin
                  MUL     -> List(Y, BR_N  , OP1_RS1, OP2_RS2 , ALU_MUL ,  WB_ALU, REN_1, MEN_0, M_X  , MT_X,  CSR.N),
                  DIVU    -> List(Y, BR_N  , OP1_RS1, OP2_RS2 , ALU_DIVU,  WB_ALU, REN_1, MEN_0, M_X  , MT_X,  CSR.N),
                  REMU    -> List(Y, BR_N  , OP1_RS1, OP2_RS2 , ALU_REMU,  WB_ALU, REN_1, MEN_0, M_X  , MT_X,  CSR.N),
                  //cyp_modify_end
